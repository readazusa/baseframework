...
public class IdWorkerUtils {
    ...
    public static IdWorkerUtils instance = new IdWorkerUtils();

    private IdWorkerUtils() {
        this(1344322705519L);
    }

    public IdWorkerUtils(long idepoch) {
    ...
    //
    public IdWorkerUtils(long workerId, long datacenterId, long sequence, long idepoch) {
